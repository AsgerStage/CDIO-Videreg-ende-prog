...
public final class OperatorDTO implements Serializable {
	...
	public OperatorDTO(int oprID, String oprNavn, String ini, String cpr, String password, int rank, String hash)
			throws OpPasswordException, OpNameException, OpIdException, DALException {
		setOprID(oprID);
		setName(oprNavn);
		setIni(ini);
		setCpr(cpr);
...
//		this.cpr = cpr;
	...
	public String toString() {
		return "OperatorDTO{" + "oprID=" + oprID + ", oprNavn=" + oprNavn + ", ini=" + ini + ", cpr=" + cpr + ", rank="
				+ rank + ", password=" + password + ", hash=" + hash + '}';
	}
	...
	public boolean equals(Object obj) {
		...
		return this.oprID == other.oprID && Objects.equals(this.oprNavn, other.oprNavn)
				&& Objects.equals(this.ini, other.ini) && this.cpr == other.cpr
				&& Objects.equals(this.password, other.password) && this.rank == other.rank
