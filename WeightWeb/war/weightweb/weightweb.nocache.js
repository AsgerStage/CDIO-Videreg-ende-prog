...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "weightweb" because\n';
  ...
  $wnd.__gwt_activeModules['weightweb'] = {
    'moduleName' : 'weightweb',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/weightweb.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['weightweb'].superdevmode = true;

  var expectedSuffix = '/weightweb.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + weightweb + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:weightweb';
  var devModeSessionKey = '__gwtDevModeSession:weightweb';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/weightweb/weightweb.nocache.js';
  ...
  $wnd.__gwt_activeModules['weightweb'].canRedirect = true;
  $wnd.__gwt_activeModules['weightweb'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/weightweb?user.agent=' + ua + '&_callback=' + callback;
